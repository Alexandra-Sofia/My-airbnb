...
<div class="js-new-listing-form new-listing-form">
    ...
    <button data-fancybox data-src="#popup-holder" class="attention-button js-new-listing">New Listing</button>
    <div id="popup-holder" style="display:none">
    <h2>Insert new listing</h2>
    <form name="NewListing" class="new-listing-form js-new-listing-form" data-user-id="${sessionScope.userID}">
